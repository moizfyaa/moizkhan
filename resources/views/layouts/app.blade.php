...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="#" class="w3-button w3-block w3-white w3-left-align" id="myBtn">Jeans </a>
  ...
  <a href="{{ route('dashboard') }}" class="w3-bar-item w3-button w3-padding">Admin</a>
</nav>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-black w3-center w3-padding-24">Powered by SCD Custom Group</div>
